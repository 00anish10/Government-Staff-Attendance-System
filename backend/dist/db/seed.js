...
const seed = async () => {
    ...
    await (0, database_1.query)(`DELETE FROM leave_requests`);
    await (0, database_1.query)(`DELETE FROM attendance`);
    await (0, database_1.query)(`DELETE FROM users`);
    await (0, database_1.query)(`DELETE FROM staff`);
    await (0, database_1.query)(`DELETE FROM designations`);
    await (0, database_1.query)(`DELETE FROM departments`);
  ...
  `);
    await (0, database_1.query)(`INSERT INTO users (username, password_hash, role, staff_id) VALUES ('admin', 'admin123', 'admin', 1)`);
    const today = new Date().toISOString().split('T')[0];
    const staffResult = await (0, database_1.query)(`SELECT id FROM staff`);
    ...
    for (const id of staffIds) {
        ...
        await (0, database_1.query)(`INSERT INTO attendance (staff_id, date, check_in, check_out, status) VALUES ($1, $2, $3, $4, $5)`, [id, today, checkIn, checkOut, status]);
    }
    await (0, database_1.query)(`
